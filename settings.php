 ...
 <div class="row">
   ...
   <nav class="navbar">
     <ul class="navbar-nav">
       ...
       <div class="hr"></div>
       <li class="nav-item">
         <a class="nav-link" href="" style="margin-left: 22px;">Settings</a>
       </li>
       <div class="hr"></div>
       <li class="nav-item">
...
<ul>
   ...
   <li class="gg"><button type="submit" class="btn btn-outline-danger" name='Changepass'><span style="font-size: 17px;">Change Password</span></button></li>
</form>
</div>
<div style="margin-top:80px;">
  <form action="feed.php" method="post">
   <li class="gg">Feedback:</li>
    <span style="margin-left:470px;"> <textarea rows="5" cols="40" name="feedbb"> </textarea></span><span style="margin-left:15px;"><button type="submit" class="btn btn-outline-danger" name='feed'>Send</button></span>
</form>
</div>
</ul>
