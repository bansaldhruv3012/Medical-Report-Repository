...
?>
 ...
 <div class="row">
   ...
   <nav class="navbar">
     <ul class="navbar-nav">
       ...
       <div class="hr"></div>
       <li class="nav-item">
         <a class="nav-link" href="">Upload New Documnet</a>
       </li>
       <div class="hr"></div>
       <li class="nav-item">
 ...
 <form action="upload1.php" method="post" enctype="multipart/form-data">
   ...
   <div class="form-group">
     <label for="upload"><b><span style="margin-left: 78px; font-size: 15px;">Select File<span style="color: #e60000;">*</span>:</span></b></label>
     <input type="file" class="upload" name="userfile" id="userfile" placeholder="Select File..." required>
     <br>
   </div>

   <span style="margin-left: 108px;">
   <button type="submit" class="btn btn-outline-success" name="submit"><span style="font-size: 17px;">Upload</span></button>
   </span>
